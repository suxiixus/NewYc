...
public class BackBillDialog extends Dialog {
    ...
    public BackBillDialog(Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = View.inflate(context, R.layout.dialog_back_bill, null);
        setContentView(view);
