...
public class AddQuanRecordAdapter extends BaseQuickAdapter<HomeRecordBean, BaseViewHolder> {
    private Context context;

    public AddQuanRecordAdapter(Context context, @Nullable List<HomeRecordBean> data) {
        super(R.layout.adapter_add_quan_record, data);
    ...
    protected void convert(BaseViewHolder helper, HomeRecordBean item) {
        ...
        ImageView iv = helper.getView(R.id.ivSelected);
