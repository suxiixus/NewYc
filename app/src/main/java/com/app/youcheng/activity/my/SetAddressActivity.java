...
public class SetAddressActivity extends BaseActivity {
    ...
    protected void initData() {
        ...
        if (userInfo != null) {
            isShow = userInfo.getShowAddress();
            if (StringUtils.isNotEmpty(userInfo.getCompanyAddress())) {
                etTxt.setText(userInfo.getCompanyAddress());
            }
            setStatus();
        }
    }
