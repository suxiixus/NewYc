...
public class SetManActivity extends BaseActivity {
    @BindView(R.id.iv1)
    ImageView iv1;
    @BindView(R.id.etTxt)
    EditText etTxt;
    ...
    protected int getViewId() {
        return R.layout.activity_set_man;
    }
    ...
    protected void initData() {
        ...
        if (userInfo != null) {
            isShow = userInfo.getShowContacts();
            if (StringUtils.isNotEmpty(userInfo.getCompanyContacts())) {
                etTxt.setText(userInfo.getCompanyContacts());
            }
            setStatus();
        }
    }
