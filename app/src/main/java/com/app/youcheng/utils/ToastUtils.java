...
public class ToastUtils {
    ...
    public static void showToast(CharSequence message) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(MyApplication.getApplication(), message, Toast.LENGTH_SHORT);
            } else {
...
//                mToast.setDuration(Toast.LENGTH_SHORT);
    ...
    public static void showToast(int resId) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(MyApplication.getApplication(), resId, Toast.LENGTH_SHORT);
            } else {
...
//                mToast.setDuration(Toast.LENGTH_SHORT);
    ...
    public static void showLong(CharSequence message) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(MyApplication.getApplication(), message, Toast.LENGTH_LONG);
            } else {
                mToast.setText(message);
            }
            mToast.show();
    ...
    public static void showLong(int resId) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(MyApplication.getApplication(), resId, Toast.LENGTH_LONG);
            } else {
                mToast.setText(resId);
            }
            mToast.show();
    ...
    public static void show(int resId, int duration) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(MyApplication.getApplication(), resId, duration);
            } else {
                mToast.setText(resId);
            }
            mToast.show();
