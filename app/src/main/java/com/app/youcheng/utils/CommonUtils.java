...
public class CommonUtils {
    ...
    public static void installAPk(File apkPath, Context context) {
        ...
        Uri apkUri = FileUtils.getUriForFile(context, apkPath);
    ...
    public static String getAppPackageName() {
        ActivityManager activityManager = (ActivityManager) MyApplication.getApplication().getSystemService(ACTIVITY_SERVICE);
